<div id="content">
  <div id="top">
    <img id="logo" src="/site/img/cmi_logo_gr.png" />
	  ...
	  <?php echo $html->link('Home', '/dashboard', array('title'=>'Home', 'class'=>'crumbs')); ?> > <?php echo $html->link('Messages', '/messages', array('title'=>'Messages', 'class'=>'crumbs')); ?>
      </div>
      <div id="topDate">
 ...
 <!-- MAIN AREA START -->
  ...
  <tr<?=($i == 1 ? " class='odd'" : "")?>>
  	...
  	<td class="tb_tools">
        <ul>
        <li><a href="/site/messages/delete/<?=$m['Messages']['id']?>" title="delete"><img src="/site/img/bt_del.gif" /></a></li>
        </ul>
	</td>
  </tr>
  <? if($i == 0) {
