...
<div id="content">
  <div id="top">
    <img id="logo" src="/site/img/cmi_logo_gr.png" />
	  ...
	  <?php echo $html->link('Home', '/admin/dashboard', array('title'=>'Home', 'class'=>'crumbs')); ?> > <?php echo $html->link('Messages', '/admin/messages', array('title'=>'Messages', 'class'=>'crumbs')); ?> > <?php echo $html->link('New Message', '/admin/messages/new', array('title'=>'New Message', 'class'=>'crumbs')); ?>
      </div>
      <div id="topDate">
 ...
 <!-- MAIN AREA START -->
  ...
  <form name="messageform" method="post" action="/site/admin/messages/send" accept-charset="utf-8">
  ...
  <tr>
  	<td>
        ...
        <div class="select" id="first_recipient">
            ...
            <div class="options">
            	<a id="a_all" href="javascript: changeSelectVal('0','all', 'All Members')" class="option">All Members</a>
				<?
				$i2 = 0;
  ...
  <a class="button_gr" id="msg_cancel" href="/site/admin/messages"><span>cancel</span></a>
  </div>
