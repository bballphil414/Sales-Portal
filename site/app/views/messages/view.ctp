<div id="content">
  <div id="top">
    <img id="logo" src="/site/img/cmi_logo_gr.png" />
	  ...
	  <?php echo $html->link('Home', '/dashboard', array('title'=>'Home', 'class'=>'crumbs')); ?> >> <?php echo $html->link('Messages', '/messages', array('title'=>'Messages', 'class'=>'crumbs')); ?> >> <?php echo $html->link('View Message', '/messages/view/'.$message['Messages']['id'], array('title'=>'View Message', 'class'=>'crumbs')); ?>
      </div>
      <div id="topDate">
 ...
 <!-- MAIN AREA START -->
  ...
  <div class="message">
  	<ul class="floatright">
        <li><a href="/site/messages/delete/<?=$message['Messages']['id']?>" title="delete"><img src="/site/img/bt_del.gif" /></a></li>
    </ul>
  ...
  <a class="button_or" id="" href="/site/messages/neww"><span>new message</span></a>
  <a class="button_gr floatright" id="" href="/site/messages"><span>see older messages</span></a>
  </div>
